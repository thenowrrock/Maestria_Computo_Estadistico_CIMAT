...
//----------------------------------Funciones generales---------------------------------------------
int validacion_tamano_suma_resta(matriz A, matriz B){
...
int validacion_tamano_inversa(int n_1, int m_1){
    if (m_1==n_1){
        ...
        cout << "Los tamanos de las matrices no son adecuados para realizar la inversa." << endl;
        cout << "-----------------------------------------------------------" << endl;
        cout << "Saliendo del programa..." << endl;
        return 0;
    }
